...
const CustomNode: React.FC<CustomNodeProps> = ({ nodeDatum, toggleNode, setSelectedNode, fetchFamilyTree, setNewChildName }) => {
      ...
      >
        ...
        <button
          ...
          style={{
            ...
            fontSize: "18px",
             // Hide for root node
            display: nodeDatum.parent === null || nodeDatum.children.length > 0 ? "none" : "block",
          }}
        >
          -
        </button>
